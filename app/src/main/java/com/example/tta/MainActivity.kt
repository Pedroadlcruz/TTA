...
@Composable
fun ThanksNoteBody(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
            .fillMaxSize()
...
@Composable
fun ThankYouNotesHeader(modifier: Modifier = Modifier) {
...
@Composable
fun TTABackground(modifier: Modifier = Modifier) {
    val image = painterResource(id = R.drawable.bg_main_purple)
    Image(
        painter = image,
        contentDescription = null,
        modifier = modifier
...
@Composable
fun FloatingsActionButton(modifier: Modifier = Modifier) {
...
@Composable
private fun ThankYouNoteScreenPreview(modifier: Modifier = Modifier) {
    TTATheme {
        ThankYouNoteScreen()
    }
